...
// 22/12/2025 : add mulit-config support
//============================================================================
// Anti-hack
...
<DIV ID=tabs>
<UL>
	<LI><A HREF="main.php?cf=<?php echo $conf_file?>&rt=lights" TITLE="<?php echo $trs["Lights_&_Groups"]?>"><SPAN CLASS="tabicon ui-icon ui-icon-lightbulb"></SPAN><?php echo $trs["Lights"]?></A></LI>
	<LI><A HREF="main.php?cf=<?php echo $conf_file?>&rt=scenes" TITLE="<?php echo $trs["Scenes_management"]?>"><SPAN CLASS="tabicon ui-icon ui-icon-image"></SPAN><?php echo $trs["Scenes"]?></A></LI>
	<LI><A HREF="main.php?cf=<?php echo $conf_file?>&rt=effects" TITLE="<?php echo $trs["Effects_management"]?>"><SPAN CLASS="tabicon ui-icon ui-icon-script"></SPAN><?php echo $trs["Effects"]?></A></LI>
	<LI><A HREF="main.php?cf=<?php echo $conf_file?>&rt=rules" TITLE="<?php echo $trs["Rules_management"]?>"><SPAN CLASS="tabicon ui-icon ui-icon-wrench"></SPAN><?php echo $trs["Rules"]?></A></LI>
	<LI><A HREF="main.php?cf=<?php echo $conf_file?>&rt=about" TITLE="<?php echo $trs["About_phpMyHue"]?>"><?php echo $trs["About"]?></A></LI>
</UL> 
</DIV><!-- /div tabs -->
</DIV><!-- /div sel -->
...
<DIV ID=detail>
<UL>
	<LI><A HREF="details.php?cf=<?php echo $conf_file?>"><?php echo $trs["Selection_details"]?></A></LI>
</UL> 
</DIV><!-- /div detail -->
</DIV><!-- /div content -->
...
<SCRIPT>
// Add used config file to javascript
var conf_file = '<?php echo $conf_file?>';
